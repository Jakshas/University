...
public abstract class Zbior {
    /** metoda ma wyszukać parę z zadanym kluczem metoda zgłasza wyjątek, gdy nie znajdzie pary o podanym kluczu */
    public abstract Para szukaj (String k) throws Exception;

    public abstract boolean szukajtf (String k) throws Exception;
    /** metoda ma wstawić do zbioru nową parę metoda zgłasza wyjątek, gdy para o podanym kluczu już jest w zbiorze */
