                ...
                using (var response = request.GetResponse())
                {
                    using (var responseStream = response.GetResponseStream())
                    {
                            ...
                            !string.IsNullOrEmpty(profile.email))
                        {
                            ...
                            identity.AddClaim(new Claim(ClaimTypes.Name, profile.given_name));
                            identity.AddClaim(new Claim(ClaimTypes.Surname, profile.family_name));
                            identity.AddClaim(new Claim(ClaimTypes.DateOfBirth, profile.date_of_birth));
